...
void main() {
  ...
  final sprintEvaluationApiProvider = SprintEvaluationApiProvider();

  test('Utils Call Test', () {
    final util = sprintEvaluation.util;
    util.callUtil();
    expect(util.call, "call");
  });

  test('API Provider Test', () async {
    sprintEvaluationApiProvider.client = MockClient((request) async {
      final mapJSON = {
        "ceremonies": [
          {
            "id": 1,
    ...
    final ceremonyItemResult = sprintEvaluationApiProvider.getCeremonyItemModel();
